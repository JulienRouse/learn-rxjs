...
_[Vous préférez la liste complète par ordre alphabétique?](complete.md)_

### Contenu (par type d'opérateur)


- [Combinaison(*Combination*)](combination/README.md)
...
- [Création(Creation)](creation/README.md)
...
- [Utilitaire(*Utility*)](utility/README.md)
